...
|---------|---------------------|-------------------|------------|----------|---------------|
| **Price (annual)** | $0-$2,388 | Free + hosting | Enterprise ($$$) | $50,000+ | Staff time |
| **Free tier** | Yes (500 docs/mo) | Yes (DIY) | No | No | N/A |
| **School plan** | $49/month | N/A | Contact sales | Contact sales | N/A |
...
| Anonymize.Education School | $588 | Everything, ready to use |
...
1. Start with free tier (500 docs/month)
...
|----------------|-----------|------------|
| Free for teachers | Anonymize.Education | 500 docs/month free |
| Affordable school solution | Anonymize.Education | $49/month, not $50,000 |
